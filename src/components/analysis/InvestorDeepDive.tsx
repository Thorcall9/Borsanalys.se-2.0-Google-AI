          ...
          <FadeIn>
            <Card mb={20}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-7">
                {( [
                  ...
                  ["Ägarstruktur","Wallenberg-stiftelserna är största ägare via FAM AB. Detta säkerställer ett unikt långsiktigt perspektiv och stabilitet som är svårreplikerad för andra investmentbolag. Du kan följa Wallenbergsfärens alla innehav genom att öppna en depå hos <a href='https://go.adt267.com/t/t?a=1582930370&as=2066019423&t=2&tk=1' target='_blank' rel='noopener noreferrer' class='text-[#10B981] underline decoration-2 underline-offset-4 hover:text-[#0d9468] transition-colors font-bold'>Nordnet</a>."],
            ...
            <div style={{background:T.accentL,border:`1.5px solid ${T.accent}33`,borderRadius:14,padding:"18px 22px",borderLeft:`4px solid ${T.accent}`}}>
              ...
              <p style={{margin:0,color:T.ink,fontSize:14,lineHeight:1.85}}>
                Investor är utan tvekan ett av de högst kvalitativa bolagen på den nordiska börsen. Wallenbergsfärens flaggskepp erbjuder en unik exponering mot globala industriledare till en attraktiv substansrabatt. Med en extremt stark balansräkning (skuldsättning 2,1%) är bolaget väl rustat för att agera offensivt i alla marknadslägen. Om du letar efter en hörnsten till portföljen är Investor ett givet val, och <a href='https://go.adt267.com/t/t?a=1582930370&as=2066019423&t=2&tk=1' target='_blank' rel='noopener noreferrer' class='text-[#10B981] underline decoration-2 underline-offset-4 hover:text-[#0d9468] transition-colors font-bold'>Nordnet</a> är den plattform vi föredrar för långsiktigt sparande.
              </p>
            </div>
          </FadeIn>
        </div>
