    ...
    <section className="border-t border-slate-200 py-10 lg:py-14">
      ...
      {adjustedMargins && <div className="mt-5 rounded-2xl border border-emerald-200 bg-emerald-50/70 p-5">
        ...
        <div className="mt-3 grid gap-4 md:grid-cols-[auto_1fr] md:items-end">
          <div><p className="font-serif text-3xl font-bold text-slate-950">{adjustedMargins.rangePct.join("–")} %</p><p className="mt-1 text-sm font-bold text-emerald-800">Justerad EBIT-marginal FY2023–FY2025</p></div>
          <p className="text-sm leading-6 text-slate-600">LTM Q2 2026: <strong className="text-slate-950">{adjustedMargins.latest.marginPct.toFixed(1)} % justerad EBIT-marginal</strong>. {adjustedMargins.comparisonNote}</p>
        </div>
