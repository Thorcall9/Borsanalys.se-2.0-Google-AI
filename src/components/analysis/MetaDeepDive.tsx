...
function MetaRevenueFlow() {
  ...
  return <figure className="mb-10 overflow-hidden rounded-[2rem] border border-border/60 bg-card shadow-xl shadow-black/5">
    ...
    <div className="overflow-x-auto premium-scrollbar bg-[#f8f0e2]"><svg data-testid="meta-revenue-sankey" aria-label="Meta-intäktsflöde Q2 2026" className="w-full min-w-[980px] p-5 md:p-8" viewBox="0 0 1280 570" role="img">
      ...
      <path d="M224 160 C276 160 303 160 353 160 L353 396 C303 396 276 396 224 396 Z" fill="url(#meta-revenue-flow)"/><path d="M224 400 C276 400 303 396 353 396 L353 400 C303 400 276 404 224 404 Z" fill="#81b9ff" opacity=".9"/><path d="M224 408 C276 408 303 400 353 400 L353 403 C303 403 276 411 224 411 Z" fill="#bed9ff" opacity=".95"/>
      <path d="M383 160 C451 160 476 160 537 160 L537 254 C476 254 451 254 383 254 Z" fill="url(#meta-profit-flow)"/><path d="M383 254 C451 254 476 254 537 254 L537 403 C476 403 451 403 383 403 Z" fill="url(#meta-cost-flow)"/>
      <path d="M722 160 C790 160 815 190 868 190 L868 265 C815 265 790 235 722 235 Z" fill="url(#meta-profit-flow)"/><path d="M722 235 C790 235 815 330 868 330 L868 349 C815 349 790 254 722 254 Z" fill="url(#meta-cost-flow)"/>
      <path d="M903 190 C967 190 992 190 1046 190 L1046 253 C992 253 967 253 903 253 Z" fill="url(#meta-profit-flow)"/><path d="M903 253 C967 253 992 330 1046 330 L1046 342 C992 342 967 265 903 265 Z" fill="url(#meta-cost-flow)"/>
