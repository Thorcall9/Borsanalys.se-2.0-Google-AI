      ...
      <div className="lg:col-span-1 space-y-6">
        <div className="p-6 bg-white/5 border border-white/5 rounded-2xl space-y-6">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-xs font-mono text-muted-foreground uppercase tracking-widest mb-2">Nuvarande FCF (Mkr)</label>
              <input 
                type="number" 
                value={currentFCF}
            ...
            <div>
              <div className="flex justify-between mb-2">
                <label className="text-xs font-mono text-muted-foreground uppercase tracking-widest">Tillväxttakt (%)</label>
                <span className="text-primary font-mono text-xs">{growthRate}%</span>
              </div>
              <input 
                type="range" 
                min="0" 
            ...
            <div>
              <div className="flex justify-between mb-2">
                <label className="text-xs font-mono text-muted-foreground uppercase tracking-widest">Avkastningskrav (%)</label>
                <span className="text-primary font-mono text-xs">{discountRate}%</span>
              </div>
              <input 
                type="range" 
                min="5" 
            ...
            <div>
              <div className="flex justify-between mb-2">
                <label className="text-xs font-mono text-muted-foreground uppercase tracking-widest">Evig Tillväxt (%)</label>
                <span className="text-primary font-mono text-xs">{terminalGrowth}%</span>
              </div>
              <input 
                type="range" 
                min="0" 
            ...
            <div className="grid grid-cols-2 gap-4 pt-4 border-t border-white/5">
              <div>
                <label className="block text-[10px] font-mono text-muted-foreground uppercase tracking-widest mb-1">Nettoskuld</label>
                <input 
                  type="number" 
                  value={netDebt}
              ...
              <div>
                <label className="block text-[10px] font-mono text-muted-foreground uppercase tracking-widest mb-1">Antal aktier</label>
                <input 
                  type="number" 
      ...
      <div className="lg:col-span-2 space-y-8">
        ...
        <div className="p-8 bg-gradient-to-br from-primary/10 to-emerald-500/10 border border-white/10 rounded-3xl text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h3 className="text-sm font-mono text-muted-foreground uppercase tracking-[0.3em] mb-4">Beräknat Motiverat Värde</h3>
            <div className="text-6xl font-serif font-bold text-white mb-2">
              {dcfData.fairValuePerShare} <span className="text-2xl font-sans text-primary">kr</span>
            </div>
            <p className="text-muted-foreground text-sm">per aktie baserat på dina antaganden</p>
          </div>
        </div>

        {/* Chart */}
        <div className="p-6 bg-white/5 border border-white/5 rounded-2xl">
          <h3 className="text-sm font-mono text-muted-foreground uppercase tracking-widest mb-6">Projicerade Kassaflöden (Mkr)</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-6 bg-white/5 border border-white/5 rounded-2xl">
            <div className="text-xs font-mono text-muted-foreground uppercase mb-2">Enterprise Value</div>
            <div className="text-2xl font-serif font-bold text-white">{dcfData.enterpriseValue} Mkr</div>
            <div className="mt-4 space-y-2">
              <div className="flex justify-between text-xs">
                <span className="text-muted-foreground">PV av Kassaflöden</span>
                <span className="text-gray-300">{dcfData.pvCashFlows} Mkr</span>
              </div>
              <div className="flex justify-between text-xs">
                <span className="text-muted-foreground">PV av Terminalvärde</span>
                <span className="text-gray-300">{dcfData.pvTerminalValue} Mkr</span>
              </div>
            </div>
          </div>
          <div className="p-6 bg-white/5 border border-white/5 rounded-2xl">
            <div className="text-xs font-mono text-muted-foreground uppercase mb-2">Equity Value</div>
