    ...
    content: `
      <div class="space-y-16">
        ...
        <div class="my-12 flex justify-center w-full">
          <a href="https://go.adt267.com/t/t?a=1582930370&as=2066019423&t=2&tk=1" target="_blank" rel="sponsored noopener noreferrer" class="block w-full max-w-[728px] hover:opacity-95 transition-opacity">
            <img src="https://track.adtraction.com/t/t?a=2067948486&as=2066019423&t=1&tk=1&i=1" alt="Öppna konto hos Nordnet" class="w-full h-auto rounded-lg shadow-sm" />
          </a>
        </div>
