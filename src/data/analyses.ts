...
export const analyses: Record<string, AnalysisData> = {
  ...
  "volvo": {
    ...
    date: "2026-03-30",
    investmentCase: "Helåret 2025 var utmanande: nettoomsättningen sjönk 9% till 479,2 mdr SEK (526,8 mdr), den justerade rörelsemarginalen föll till 10,7% (12,0%) och det operativa kassaflödet minskade till 38,3 mdr SEK (45,8 mdr). Trots motvinden bibehåller Volvo en urstark finansiell ställning med en nettokassa på 66 mdr SEK och föreslår en utdelning på 13,00 kr per aktie. Den teknologiska transformationen accelererar under ny ledning (Christian Levin tog över som VD 2025), med fokus på modulära plattformar och mjukvarudefinierade fordon för att säkra framtida konkurrenskraft.",
    ...
    growth: "Tillväxten förväntas drivas av nästa generations modulära plattformar och en ökad andel mjukvarurelaterade tjänster, vilket ska förbättra marginalerna över tid.",
    financialAnalysis: "Nettoomsättningen sjönk 9% under 2025 till 479,2 mdr SEK. Justerad rörelsemarginal föll till 10,7%. Nettokassan uppgår till 66 mdr SEK och utdelningen föreslås till 13,00 kr per aktie.",
    competitiveAdvantages: [
      "Starka varumärken (Volvo, Mack, Renault Trucks)",
      "Bred serviceverksamhet som ger stabila kassaflöden",
      "Ledande inom elektrifiering av tunga transporter",
      "Globalt distributions- och servicenätverk"
    ],
    risks: [
      "Cyklisk efterfrågan på fordonsmarknaden",
      "Höga investeringskostnader för ny teknik",
      "Geopolitisk osäkerhet och handelshinder"
    ],
    valuation: "Med en riktkurs på 345 kr och nuvarande kurs på 324 kr ser vi en begränsad uppsida i det korta perspektivet. Värderingen reflekterar de utmaningar bolaget står inför i en svagare konjunktur.",
    conclusion: "Volvo är ett fundamentalt starkt bolag i en transformationsfas. Givet den nuvarande marknadssituationen och den begränsade uppsidan till vår riktkurs väljer vi att bevaka aktien i väntan på tydligare tecken på återhämtning.",
    ...
    managementOverview: "Christian Levin — VD (sedan 2025): Driver transformationen mot mjukvarudefinierade fordon.",
    ownershipStructure: "Industrivärden och Geely kvarstår som de största strategiska ägarna.",
    strengths: ["Finansiell styrka", "Serviceaffär", "Varumärke"],
    weaknesses: ["Cyklisk exponering", "Marginalpress"],
    opportunities: ["Mjukvarutjänster", "Elektrifiering"],
    threats: ["Lågkonjunktur", "Konkurrens"],
    scenarios: [
