...
export const analyses: Record<string, AnalysisData> = {
  ...
  "volvo": {
    ...
    financialAnalysis: "Nettoomsättningen sjönk 9% under 2025 till 479,2 mdr SEK. Justerad rörelsemarginal föll till 10,7% (12,5%). Operativt kassaflöde halverades till 21,8 mdr SEK. Styrelsen föreslår en total utdelning om 13,00 kr (8,50 + 4,50), vilket ger en direktavkastning på 4,0% vid kurs 324 kr. Nettokassan uppgår till 63,0 mdr SEK.",
    competitiveAdvantages: [
