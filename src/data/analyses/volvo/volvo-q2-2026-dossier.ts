...
const claims: VolvoClaim[] = [
  ...
  { claimId: "VOLVO-D-007", class: "DERIVED", status: "DECISION_GRADE", text: "Vid 250,35875 kr är annualiserad värdepotential till 2028-12-31 9,13 % och Bear-nedsidan 23,25 %. Vid 308,5775 kr är annualiserad värdepotential 0,00 % och Bear-nedsidan 37,73 %.", effectiveDate: "2026-08-10", sourceRefs: ["VOLVO-F-014", "VOLVO-D-004", "VOLVO-D-005"], formula: "Annualiserad värdepotential(P) = (308,5775/P)^(1/(874/365,25))−1. Bear-nedsida(P) = min(192,14/P−1, 0). Nedre gränsen = (308,5775+192,14)/2." },
...
export const VOLVO_Q2_2026_DOSSIER = {
  ...
  riskRewardZones: {
    status: "APPROVED",
    visibility: "MEMBER",
    method: "Fasta redaktionella zoner från Volvos sannolikhetsvägda värde, realistiska Bear-scenario, medelrisk och samma värderingsdatum. De är inte personliga råd.",
    valuationDate: "2028-12-31",
    ...
    boundaries: [
      { boundaryId: "attractive-threshold", canonicalPrice: { value: 250.35875, currency: "SEK" }, annualizedValuePotential: 0.09130589256798216, bearDownside: -0.2325413032298651, risk: "MEDEL", rationale: "Här är den möjliga uppgången till sannolikhetsvägt värde lika stor i kronor som nedsidan till det realistiska Bear-scenariot. Under nivån förbättras säkerhetsmarginalen tydligt.", derivedClaimIds: ["VOLVO-D-007"] },
      { boundaryId: "weak-threshold", canonicalPrice: { value: 308.5775, currency: "SEK" }, annualizedValuePotential: 0, bearDownside: -0.3773363255584091, risk: "MEDEL", rationale: "Här sammanfaller aktiekursen med sannolikhetsvägt värde. Över nivån är den modellerade annualiserade kursvärdepotentialen negativ samtidigt som Bear-nedsidan är betydande.", derivedClaimIds: ["VOLVO-D-007"] },
    ],
    zones: [
      { zone: "ATTRACTIVE", priceInterval: { min: null, max: 250.35875, currency: "SEK", minInclusive: false, maxInclusive: false }, boundaryRefs: ["attractive-threshold"], rationale: "Förbättrad säkerhetsmarginal för Volvos medelrisk och cykliska exponering.", derivedClaimIds: ["VOLVO-D-007"], presentation: { title: "Attraktiv risk/reward", priceLabel: "Under 250,36 kr", annualPotentialLabel: "Cirka +9,1 %/år eller högre", bearDownsideLabel: "Bear-nedsida: cirka −23 % eller mindre" } },
      { zone: "BALANCED", priceInterval: { min: 250.35875, max: 308.5775, currency: "SEK", minInclusive: true, maxInclusive: false }, boundaryRefs: ["attractive-threshold", "weak-threshold"], rationale: "Värderingen är fortfarande rimlig, men relationen mellan möjlig värdepotential och Bear-nedsida blir successivt mindre asymmetrisk.", derivedClaimIds: ["VOLVO-D-007"], presentation: { title: "Balanserad risk/reward", priceLabel: "250,36–308,58 kr", annualPotentialLabel: "Cirka +9,1 till 0,0 %/år", bearDownsideLabel: "Bear-nedsida: cirka −23 till −38 %" } },
      { zone: "WEAK", priceInterval: { min: 308.5775, max: null, currency: "SEK", minInclusive: true, maxInclusive: false }, boundaryRefs: ["weak-threshold"], rationale: "Begränsad säkerhetsmarginal: den sannolikhetsvägda annualiserade kursvärdepotentialen är noll eller negativ medan Bear-nedsidan ökar.", derivedClaimIds: ["VOLVO-D-007"], presentation: { title: "Svag risk/reward", priceLabel: "Från 308,58 kr", annualPotentialLabel: "0,0 %/år eller lägre", bearDownsideLabel: "Bear-nedsida: minst cirka −38 %" } },
    ],
  ...
  version: { versionId: "volvo-q2-2026-v6", parentVersionId: "volvo-q2-2026-v5", createdAt: "2026-08-17", author: "Börsanalys.se / Codex research", status: "PUBLISH_READY", immutable: true },
  changeTracking: [
