...
const claims: VolvoClaim[] = [
  ...
  { claimId: "VOLVO-D-008", class: "DERIVED", status: "DECISION_GRADE", text: "Från referenskursen 354,60 kr den 10 augusti 2026 till 31 december 2028 är Bear/ sannolikhetsvägt/Bull 192,14/308,58/389,85 kr. Det motsvarar −22,59/−5,64/+4,04 % annualiserad kursvärdepotential exklusive utdelningar. Avståndet är 116,44 kr från Bear till sannolikhetsvägt värde och 81,27 kr från sannolikhetsvägt värde till Bull.", effectiveDate: "2026-08-10", sourceRefs: ["VOLVO-F-014", "VOLVO-D-004"], formula: "Årlig potential = (scenariovärde / 354,60)^(1/(874/365,25))−1. Spridning = skillnaden mellan scenario-värdena. Utdelningar ingår inte." },
...
export const VOLVO_Q2_2026_DOSSIER = {
  ...
  riskRewardZones: {
    ...
    memberInsight: {
      companyLabel: "AB Volvo",
      ticker: "VOLV-B.ST",
      referencePriceLabel: "354,60 kr",
      referenceDateLabel: "10 augusti 2026",
      ...
      marker: {
        zoneId: "WEAK",
        positionPct: 84,
        label: "Referenskurs vid analystillfället",
        note: "Markören visar vilken redaktionell zon kursen låg i vid analystillfället, inte en live-kurs eller handelssignal.",
      },
      scenarioSpread: {
        label: "Scenariospann till 31 december 2028",
        points: [
          { label: "Bear", valueLabel: "192,14 kr", annualPotentialLabel: "−22,6 %/år" },
          { label: "Sannolikhetsvägt värde", valueLabel: "308,58 kr", annualPotentialLabel: "−5,6 %/år" },
          { label: "Bull", valueLabel: "389,85 kr", annualPotentialLabel: "+4,0 %/år" },
        ],
        rangeSharesPct: [58.89307571695919, 41.10692428304082],
        distanceLabel: "Bear → sannolikhetsvägt: 116,44 kr · Sannolikhetsvägt → Bull: 81,27 kr",
      },
  ...
  version: { versionId: "volvo-q2-2026-v8", parentVersionId: "volvo-q2-2026-v7", createdAt: "2026-08-27", author: "Börsanalys.se / Codex research", status: "PUBLISH_READY", immutable: true },
  changeTracking: [
    ...
    { fieldPath: "valuation.riskRewardZones.memberInsight", oldValueRef: null, newValueRef: "volvo-q2-2026-v8", reason: "Medlemsinsikten får ett separat godkänt presentationsunderlag för kursmarkör och scenariospann. Värdering, zoner, rekommendation och övriga beslutspåverkande antaganden är oförändrade.", claimIds: ["VOLVO-D-004", "VOLVO-D-005", "VOLVO-D-007", "VOLVO-D-008", "VOLVO-N-002"], changedBy: "Codex", changedAt: "2026-08-27" },
  ],
} as const;
