...
const scenarios = [
  { id: "bear" as const, label: "Försiktigt", probability: 0.25, revenue: { subscription: 55.4, advertising: 2.4, other: 0.3 }, ebitMargin: 0.305, netFinance: -0.6, taxRate: 0.18, dilutedShares: 4.051, peMultiple: 18, multipleRationale: "Lägre tillväxt, svagare reklamutfall och mindre visibilitet i marginalen motiverar en multipel nära ett moget mediebolag.", repurchases: 18, repurchasePrice: 90, sbcShares: 0.03, contentAmortization: 19.0, contentPayments: 19.4, contentLiabilityChange: 0, capex: 0.6, workingCapital: 0.2, description: "Svagare medlems- och prisutveckling, annonser under plan och en mognare multipel." },
  { id: "base" as const, label: "Huvudscenario", probability: 0.55, revenue: { subscription: 57.5, advertising: 3.6, other: 0.3 }, ebitMargin: 0.34, netFinance: -0.5, taxRate: 0.18, dilutedShares: 3.951, peMultiple: 23, multipleRationale: "En premievärdering kräver att reklamen skalar, pris/mix håller och den högre marginalen också konverteras till normaliserat kassaflöde.", repurchases: 30, repurchasePrice: 100, sbcShares: 0.03, contentAmortization: 21.0, contentPayments: 22.0, contentLiabilityChange: 0.3, capex: 0.8, workingCapital: 0.4, description: "Monetiseringen fortsätter, reklam växer från 2026 års nivå och operating leverage består." },
  { id: "bull" as const, label: "Positivt", probability: 0.20, revenue: { subscription: 59.3, advertising: 4.1, other: 0.3 }, ebitMargin: 0.36, netFinance: -0.4, taxRate: 0.18, dilutedShares: 3.856, peMultiple: 28, multipleRationale: "En uthållig kvalitets-/tillväxtpremie förutsätter att reklam, pris/mix, innehållseffektivitet och kapitalallokering levererar samtidigt.", repurchases: 40.15, repurchasePrice: 110, sbcShares: 0, contentAmortization: 22.0, contentPayments: 22.5, contentLiabilityChange: 0.5, capex: 1.0, workingCapital: 0.5, description: "Reklam, pris/mix och innehållseffektivitet levererar samtidigt; multipelpremien består." },
];
