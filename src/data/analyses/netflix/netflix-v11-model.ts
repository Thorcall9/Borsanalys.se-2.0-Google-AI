...
export const netflixV112Dossier = {
  ...
  insight: "Netflix förbättrar monetiseringen genom pris, planmix och reklam, men värderingsutfallet avgörs främst av om marginalexpansionen och den organiska vinsttillväxten blir uthålliga.",
  claims: [
