...
export const alphabetRiskRewardZones = {
  ...
  presentation: {
    ...
    memberInsight: {
      identityLabel: "Alphabet · GOOG",
      referencePriceLabel: "353,47 USD",
      referenceDateLabel: "7 aug 2026",
      assessmentLabel: "Svag risk/reward",
      assessmentRationale: "Begränsad säkerhetsmarginal mot vårt sannolikhetsvägda värde samtidigt som Bear-nedsidan är betydande.",
      zoneSharesPct: [32, 39, 29],
      markers: [
        { id: "reference" as const, positionPct: 80.5, label: "▼ Kurs 353 USD", placement: "above" as const, align: "center" as const },
        { id: "weighted-fair-value" as const, positionPct: 93, label: "Vårt värde 387 USD", placement: "below" as const, align: "end" as const },
      ],
      footerNote: "Kurs vid analystillfället, inte en live-kurs. Risk/reward-zonerna är Börsanalys.se:s fasta redaktionella bedömning, inte personlig rådgivning.",
    },
  },
