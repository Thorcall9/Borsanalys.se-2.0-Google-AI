...
export const swedbank2025: AnalysisData = {
  ...
  marketCap: "361 Mdkr",
  summary: "Kvalitetsbank med stark marknadsposition, låg kostnadsbas, mycket stark kreditkvalitet och robust kapitalisering. För en bank är det främst lönsamhet, kapitalstyrka och utdelningskapacitet som bär caset.",
  date: "2026-04-10",
  
  marketOverview: "Swedbank är en nordisk universalbank med tyngdpunkt i Sverige och Baltikum. Banken erbjuder utlåning, sparande, betalningar, kort, kapitalförvaltning, försäkring och företagsfinansiering. Under 2025 kom 71 procent av intäkterna från Sverige, 25 procent från Baltikum sammantaget och 4 procent från övriga marknader. Banken hade 7,3 miljoner privatkunder, 545 000 företagskunder och en ledande marknadsposition i Baltikum, där kredittillväxten varit klart högre än i Sverige.\n\nAffärsmodellen bygger på att vara navet i kundens ekonomi, vilket skapar höga byteskostnader och låg kundfriktion. Ledningen under Jens Henriksson har framgångsrikt navigerat banken från sanering till att åter leverera på finansiella mål, med den nya planen 'Swedbank 15/27' som siktar på minst 15% ROE fram till 2027.",
  
  investmentCase: "Swedbanks moat bygger på fem huvudpelare: ett mycket starkt varumärke, Sparbanksekosystemets unika distributionskraft, en av Europas lägsta kostnadskvoter (K/I 0,36), ledande digital distribution och strategiska strukturaffärer som Stabelo och Entercard. K/I-talet på 0,36 är ett tydligt kvalitetsbevis och mycket starkt i nordisk storbankskontext.\n\nTrots en mogen marknad ser vi tillväxtmöjligheter i Baltikums starkare BNP-utveckling och kredittillväxt, samt genom synergier från förvärven som breddar intäktsmixen och stödjer bilden av en bank med hög utdelningskapacitet.",
  
  competitiveAdvantages: [
    "Sparbanksekosystemets unika distributionskraft och lokala förankring",
    "Kostnadsledarskap: K/I-kvot på 0,36, mycket starkt i storbankskontext",
    "Marknadsposition Baltikum: Ledande marknadsandelar och hög tillväxt",
    "Byteskostnader: Hög kundlojalitet genom helhetserbjudanden",
    "Stabelo & Entercard: Strategiska förvärv som stödjer intjäningsförmågan"
  ],
  
  financialAnalysis: "2025 präglades av en normalisering efter exceptionella ränteår. Nettointäkterna landade på 68 736 Mkr (-7% mot 2024), drivet av ett lägre räntenetto på 44 000 Mkr. Trots detta hölls kostnaderna i stramt tygel (24 532 Mkr, -3%) och ROE förblev starkt på 15,2%. Kreditkvaliteten var mycket stark med en kreditförlustnivå på 0,00%. Kapitaliseringen är robust med en CET1-kvot på 17,8%. Det totala kärnprimärkapitalkravet inklusive Pelare 2-vägledning var 14,8%, vilket ger en buffert på 3,0 procentenheter.",
  
  growth: "Caset bygger på stabila tillväxtmotorer: volymtillväxt i svenska bolån via Stabelo, starkare kredittillväxt i Baltikum (klart högre än i Sverige 2025), samt ökad transaktionsbaserad intjäning via Entercard. Digitalisering, AI-stöd och processautomation kan bidra till att hålla K/I-kvoten i schack trots löneökningar och ökade IT-investeringar.",
  ...
  risks: [
    "Regulatorisk risk: Department of Financial Services i New York utreder fortfarande banken",
    "Räntemarginaltryck: Känslighet för fortsatta räntesänkningar",
    "Pensionsmyndighetens krav: Juridisk risk kopplat till Optimus High Yield (2 790 Mkr)",
    "Fastighetsexponering: Känslighet för ett svagare bostadsmarknadsscenario"
  ],
  
  ukgcRiskDeepDive: "Department of Financial Services i New York utreder fortfarande Swedbank trots att DOJ avslutade sin utredning utan åtgärd i januari 2026. Därtill utgör Pensionsmyndighetens krav en separat juridisk riskpost att bevaka.",
  ...
  aiDrivenData: {
    ...
    overview: {
      ...
      agarstruktur: "Sparbanksgruppen är fortsatt största ägare och ägarbilden är stabilt institutionell med inslag av Folksam och Robur."
    },
    strategiskMoat: {
      swot: {
        styrkor: [
    ...
    sammanfattning: {
      beslut: "BEVAKA",
      motivering: "Aktien är attraktiv som kvalitetsbank och utdelningscase, men det tydligare köpläge uppstår först vid svaghet eller marknadsoro.",
      malpris: "330-360 SEK"
    },
    scenarier: {
