...
export const abb2026: AnalysisData = {
  ...
  investmentCase:
    "ABB är exponerat mot tre av de starkaste industriella megatrenderna: AI-infrastruktur, elektrifiering och energieffektivisering. Electrification-segmentet, som står för ~60 % av orderingången, växte 44 % jämförbart i Q1 2026.",
  ...
  valuation:
    "P/E 38,7x vs historiskt snitt 26,9x (+44 % premie). EV/EBITDA 21,3x. EV/EBIT 24,3x. Direktavkastning 1,12 %. Konsensus EPS 2026e 31,37 SEK × forward P/E 31,6x = 991 SEK – ingen uppsida på konsensus.",
  ...
  employees: "105 000+",
  managementOverview: "VD Morten Wierod. Fokus på kärnverksamhet, disciplinerad kapitalallokering och ökad förvärvstakt.",
  ownershipStructure: "Spritt ägande. Cevian Capital, BlackRock och Fidelity bland de större institutionella ägarna.",

  strengths: [
    "Global marknadsledare inom elektrifiering och automation",
    "Orderbok på 27,5 md USD (+22 % jämförbart) – >1 års omsättning",
  ...
  opportunities: [
    ...
    "Marginell expansion om Gamesa-integration lyckas",
  ...
  threats: [
    ...
    "Geopolitik och tullar påverkar leveranskedjor",
    "Ränteuppgång dämpar industriinvesteringar",
    "Konkurrens från Siemens, Schneider och Eaton",
  ],
  ...
  scenarios: [
    {
      ...
      change: "+22 %",
      probability: "25 %",
      description: "Electrification behåller 44 % ordertillväxt. Marginal >22 % utan engångsstöd. P/E 35x på EPS 34,51 SEK.",
    },
    {
      type: "base",
      label: "Bas",
      ...
      change: "−11 %",
      probability: "50 %",
      description: "Konsensus EPS 31,37 SEK och P/E normaliseras mot 28x. Bra bolag men avkastningen styrs av ingångsvärderingen.",
    },
    {
      type: "bear",
      label: "Bear",
      ...
      change: "−41 %",
      probability: "25 %",
      description: "Industriavmattning pressar Motion/Automation. EPS 26,66 SEK (−15 % vs konsensus) och P/E 22x mot historisk bottennivå.",
    },
  ],
